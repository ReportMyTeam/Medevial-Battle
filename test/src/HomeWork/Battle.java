...
public class Battle extends Army {
	...
	{
		return army1.Generate_rand();
	}
	
	public int choosen_fighters_army2 ()
	{
		return army2.Generate_rand();
	}
	...
	while (i < army1.get_size()) { //print army1
	...
	i=0;
	while (i < army2.get_size()) { //print army2
	...
	//	choosen_fighters_army2();
		...
		while (army1.get_size()>0 && army2.get_size()>0)
		{		
		...
		if (army1.get_size() == 0 && army2.get_size() == 0)
